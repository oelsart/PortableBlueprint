...
namespace PortableBlueprint
{
    public class Designator_MakeBlueprint : Designator
    {
        ...
        {
            this.defaultLabel = "PB.DesignatorMakeBlueprint".Translate();
            this.defaultDesc = "PB.DesignatorMakeBlueprintDesc".Translate();
            this.icon = ContentFinder<Texture2D>.Get("PortableBlueprint/UI/MakeBlueprint", true);
