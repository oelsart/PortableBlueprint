...
namespace CarryableBlueprint
{
    public class Designator_PlaceBlueprint : Designator
    {
        ...
        {
            this.comp = comp;
            this.defaultLabel = "CB.DesignatorPlaceBlueprint".Translate();
            this.defaultDesc = "CB.DesignatorPlaceBlueprintDesc".Translate();
            this.icon = ContentFinder<Texture2D>.Get("CarryableBlueprint/UI/PlaceBlueprint", true);
        ...
        public override void DoExtraGuiControls(float leftX, float bottomY)
        {
            ...
            Find.WindowStack.ImmediateWindow(73095, winRect, WindowLayer.GameUI, delegate
            {
                ...
                Widgets.Label(new Rect(0f, winRect.height - 38f, winRect.width, 30f), "CB.HoldShiftToFlip".Translate());
