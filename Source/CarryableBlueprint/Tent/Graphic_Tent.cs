...
namespace CarryableBlueprint.Tent
{
    ...
    {
        public override Material MatSingle => MaterialAtlasPool.SubMaterialFromAtlas((this.subGraphics[0] as Graphic_Appearances).SubGraphicFor(CB_DefOf.Fabric).MatSingle, LinkDirections.None);
        ...
        {
            Log.WarningOnce("[CarryableBlueprint] Graphic_Tent must be wrapped. This usually occurs after defs hotreload.", 54651343);
        }
