    ...
    public class JobDriver_BuildTentRoof : JobDriver_AffectRoof
    {
        ...
        protected override void DoEffect()
        {
            for (int i = 0; i < 9; i++)
            {
                ...
                if (intVec.InBounds(base.Map) && base.Map.areaManager.Get<Area_BuildTentRoof>()[intVec] && base.Map.roofGrid.RoofAt(intVec) != CB_DefOf.CB_TentRoof && TentRoofUtility.GetFirstRoofHolder(intVec, base.Map, false) != null && RoofUtility.FirstBlockingThing(intVec, base.Map) == null)
                {
                    base.Map.roofGrid.SetRoof(intVec, CB_DefOf.CB_TentRoof);
        ...
        {
            return base.Cell.GetRoof(base.Map) == CB_DefOf.CB_TentRoof;
        }
    }
}
